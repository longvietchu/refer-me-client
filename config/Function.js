...
export const formatDateTimeDDMMTommorrow = (time) =>
...
export const getTimeHHMM = (time) => {
  let str = moment(time).locale("vi").format("DD/MM/YYYY HH:mm");
  return str.substring(11, 16);
};

export const getTimeHH = (time) => {
  let str = moment(time).locale("vi").format("HH:mm");
  return str;
};

export const formatDateYYYY = (time) => {
...
export const getDateVisitor = (time) => {
...
export const formatTimeDDSS = (time) => {
