...
export default function RejectSeminar(props) {
    const classes = useStyles();

    const { modalIsOpen, closeModal, submitRejectSeminar, itemSelected } = props;
    ...
    const rejectForm = () => {
        submitRejectSeminar({
            api_name: "api.v1.features.seminar.update_status",
